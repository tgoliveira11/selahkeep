...
- **Account authentication:** [`@tgoliveira/secure-auth@0.1.15-internal`](https://www.npmjs.com/package/@tgoliveira/secure-auth) (experimental 0.1.x — security review before production)

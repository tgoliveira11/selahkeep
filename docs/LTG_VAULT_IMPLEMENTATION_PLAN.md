...
- Keeping **account authentication** exclusively in `@tgoliveira/secure-auth@0.1.16-internal`
...
Remove inconsistent local auth; use `@tgoliveira/secure-auth@0.1.16-internal` as the only account/auth source; stabilize build and deployment; preserve product pages.
...
- Package upgrades beyond `0.1.16-internal` unless security patch

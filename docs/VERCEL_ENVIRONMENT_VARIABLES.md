...
Expect `{ "ok": true, "package": "@tgoliveira/secure-auth", ... }` when runtime secrets and DB are configured.
...
- [`docs/migrations/secure-auth-deployment-checklist.md`](./migrations/secure-auth-deployment-checklist.md)

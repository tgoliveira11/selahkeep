...
/** Logged-in home while the vault is locked — unlock CTA + reassurance (no note content). */
export function VaultLockedHomeContent() {
  return (
    <div className="mx-auto max-w-3xl">
      <VaultLockedState variant="notes-list" returnTo={LOGGED_IN_HOME_PATH} />

...
/**
 * Official Google "G" mark colors per Google Identity branding guidelines.
...
/**
 * Apple mark for light backgrounds per Sign in with Apple guidelines.
...
/**
 * Microsoft four-square logo colors per Microsoft identity branding.
...
export function OAuthProviderLogo({
  ...
  providerId: OAuthProviderLogoId | string;
  className?: string;
}) {
  switch (providerId) {
    case "google":
    ...
    case MICROSOFT_OAUTH_PROVIDER_ID:

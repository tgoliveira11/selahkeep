...
describe("passkey vault unlock PRF ceremony parity", () => {
  it("enable-vault-unlock and unlock share prepareVaultUnlockAuthenticationOptions", () => {
    const enable = readSource("src/lib/passkey/enable-vault-passkey-unlock.ts");
    ...
    expect(enable).toContain("prepareVaultUnlockAuthenticationOptions");

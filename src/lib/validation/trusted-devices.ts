...
export const relinkTrustedDeviceSchema = z.object({
  devicePublicKey: z.record(z.unknown()),
  browser: z.string().optional(),
  platform: z.string().optional(),
  deviceType: z.enum(["desktop", "mobile", "tablet", "unknown"]).optional(),
  encryptedVaultKey: encryptedPayloadSchema,
...
export type RelinkTrustedDeviceInput = z.infer<typeof relinkTrustedDeviceSchema>;
